...
function[EulerSpiNaN,EulerSpi,EulerNaN,Euler] = N_EulerianData(velMeanOrderX,velMeanOrderY,StdVelOrderX,StdVelOrderY,velXYmeanOrder,VELXYmeanOrder,STDVELXYOrder,NewLabel,distX2_mean,Spi)
