function [velX,velY,velX_mean,velY_mean,StdVelX,StdVelY,STDVELXY,distanceXY_mean,velocityXY_mean,VELOCITYXY_mean,velX2_mean,velY2_mean] = N_MedianStd(distX2_mean,distY2_mean,DISTXY2_mean,distX,distY,DISTXY,frequency,step) 
