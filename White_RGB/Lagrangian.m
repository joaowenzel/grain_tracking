...
function [lagrangian,lagrangianlong,LargestTracking,usefullagrangian,lag12plus,LgrNofMov,tracklist,lagrangiandata] = Lagrangian(pair,MinTS,deltaY,speedY,frequency,P2MM)
    ...
    [lagrangianlong,LargestTracking] = LagrangianLong(lagrangian,MinTS);

    [usefullagrangian,lag12plus,LgrNofMov] = UsefulLagrangian(lagrangianlong,deltaY,speedY);   

    [tracklist] = TrackList(usefullagrangian,frequency,P2MM);

    [lagrangiandata] = LagrangianData(tracklist);
