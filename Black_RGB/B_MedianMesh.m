function[distX,distY,DISTXY] = B_MedianMesh(pair,n,nf,step,mesh,width,height,P2MM,allposXY)
    ...
    for nimg = ninitial:nfinal  
        ...
        [Compare,hf] = B_COMPARE(pair,nimg,width,height,mesh,Compare,allposXY); % This function returns the elements inside each square of mesh
                                                                                % It's better explained inside the function!    
        [distX,distY,DISTXY] = B_DistXDistY(Compare,nimg,pair,Comp,indeximg,hf,step,mesh,distX,distY,DISTXY,P2MM);    
