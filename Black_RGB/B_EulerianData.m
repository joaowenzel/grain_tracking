...
function[EulerSpiNaN,EulerSpi,EulerNaN,Euler] = B_EulerianData(velMeanOrderX,velMeanOrderY,StdVelOrderX,StdVelOrderY,velXYmeanOrder,VELXYmeanOrder,STDVELXYOrder,NewLabel,distX2_mean,Spi)
