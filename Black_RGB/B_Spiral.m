...
function[velMeanOrderX,velMeanOrderY,StdVelOrderX,StdVelOrderY,velXYmeanOrder,VELXYmeanOrder,STDVELXYOrder,NewLabel,Spi] = B_Spiral(mesh,velX_mean,velY_mean,StdVelX,StdVelY,velocityXY_mean,VELOCITYXY_mean,STDVELXY,P2MM)
    ...
    if mesh == 25        
        ...
        velMeanOrderX = nan(1312,3); % velX_mean (X velocity) in Spiral order 
        [x1,y1] = find(Spi==1);
