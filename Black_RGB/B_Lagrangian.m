...
function [lagrangian,lagrangianlong,LargestTracking,usefullagrangian,lag12plus,LgrNofMov,tracklist,lagrangiandata] = B_Lagrangian(pair,MinTS,deltaY,speedY,frequency,P2MM)
    ...
    [lagrangianlong,LargestTracking] = B_LagrangianLong(lagrangian,MinTS);

    [usefullagrangian,lag12plus,LgrNofMov] = B_UsefulLagrangian(lagrangianlong,deltaY,speedY);   

    [tracklist] = B_TrackList(usefullagrangian,frequency,P2MM);

    [lagrangiandata] = B_LagrangianData(tracklist);
