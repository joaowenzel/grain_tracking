...
function [pair] = B_Pair(allposXY,MD2LF,frequency,P2MM)
...
%             unmatched in the next image (the tracer is no more visible).
            ...
            GNII(7,1) = (allposXY{2,img+1}(GNII(1,1))); 
            GNII(7,2) = (allposXY{2,img+1}(GNII(1,2)));
            GNII(7,3) = (allposXY{2,img+1}(GNII(1,3)));
